...
python3 main.py train -input_dim 40 -model A -bs 125 -info "0615 | RNN (A) | first 200 feature + quadratic | ABSLoss" -record records/0616_rnn_A.txt
python3 main.py train -input_dim 40 -model C -bs 125 -info "0616 | RNN (C) | first 200 feature + quadratic - bidirectional | ABSLoss" -record records/0616_rnn_C_2.txt